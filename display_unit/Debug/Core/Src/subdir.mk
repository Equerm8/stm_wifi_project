...
C_SRCS += \
../Core/Src/auxiliary_functions.c \
../Core/Src/gpio.c \
../Core/Src/main.c \
../Core/Src/operational_variables.c \
../Core/Src/spi.c \
...
OBJS += \
./Core/Src/auxiliary_functions.o \
./Core/Src/gpio.o \
./Core/Src/main.o \
./Core/Src/operational_variables.o \
./Core/Src/spi.o \
...
C_DEPS += \
./Core/Src/auxiliary_functions.d \
./Core/Src/gpio.d \
./Core/Src/main.d \
./Core/Src/operational_variables.d \
./Core/Src/spi.d \
...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/auxiliary_functions.cyclo ./Core/Src/auxiliary_functions.d ./Core/Src/auxiliary_functions.o ./Core/Src/auxiliary_functions.su ./Core/Src/gpio.cyclo ./Core/Src/gpio.d ./Core/Src/gpio.o ./Core/Src/gpio.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/operational_variables.cyclo ./Core/Src/operational_variables.d ./Core/Src/operational_variables.o ./Core/Src/operational_variables.su ./Core/Src/spi.cyclo ./Core/Src/spi.d ./Core/Src/spi.o ./Core/Src/spi.su ./Core/Src/stm32l4xx_hal_msp.cyclo ./Core/Src/stm32l4xx_hal_msp.d ./Core/Src/stm32l4xx_hal_msp.o ./Core/Src/stm32l4xx_hal_msp.su ./Core/Src/stm32l4xx_it.cyclo ./Core/Src/stm32l4xx_it.d ./Core/Src/stm32l4xx_it.o ./Core/Src/stm32l4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32l4xx.cyclo ./Core/Src/system_stm32l4xx.d ./Core/Src/system_stm32l4xx.o ./Core/Src/system_stm32l4xx.su ./Core/Src/tim.cyclo ./Core/Src/tim.d ./Core/Src/tim.o ./Core/Src/tim.su ./Core/Src/usart.cyclo ./Core/Src/usart.d ./Core/Src/usart.o ./Core/Src/usart.su
